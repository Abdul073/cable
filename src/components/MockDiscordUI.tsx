...
import { Cog, Gift, Headphones, HelpCircle, Inbox, Menu, Mic, Phone, Pin, PlusCircle, Search, Smile, Sticker, UserCircle, UserCircleIcon, Video } from "lucide-react";
...
export const MockDiscordUI = ({children}: PropsWithChildren) => {
    return <div className="flex min-h-[800px] w-full max-w-[1200px] bg-discord-background text-white rounded-lg overflow-hidden shadow-xl">
        ...
        <div className="hidden sm:flex w-[72px] bg-[#202225] py-3 flex-col items-center">
            ...
            <div className="group mt-auto size-12 bg-discord-background rounded-3xl flex items-center justify-center mb-3 hover:rounded-xl transition-all duration-200 hover:bg-[#3ba556] cursor-not-allowed">
                <PlusCircle className="text-[#3ba556] group-hover:text-white"/>
            </div>
        </div>
        ...
        <div className="hidden md:flex w-60 bg-[#2f3136] flex-col">
            ...
            <div className="flex-1 overflow-y-auto pt-4">
                ...
                <div className="px-2 mb-4">
                    ...
                    <div className="flex items-center px-2 py-1.5 rounded bg-[#393c43] text-white cursor-not-allowed">
                        <Image src="/brand-asset-profile-picture.png" alt="PingPanda Avatar" width={32} height={32} className="object-cover rounded-full mr-3"/>
            ...
            <div className="h-16 bg-[#36393f] flex  items-center px-4 shadow-sm border-b border-[#202225]">
                ...
                <div className="flex items-center">
                    <div className=" relative">
                        <Image src="/brand-asset-profile-picture.png" alt="PingPanda Avatar" width={40}
                        height={40} className="object-cover rounded-full mr-3"/>
