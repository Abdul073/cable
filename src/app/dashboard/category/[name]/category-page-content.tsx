...
export const CategoryPageContent = ({hasEvents: initialHasEvents, category}: CategoryPageContentProps) => {
    ...
    const [activeTab, setActive] = useState<"today" | "week" | "month">("today")
            ...
            : []),
            {
                ...
                cell: ({row}) => (
                    <span className={cn("px-2 py-1 rounded-full text-xs font-semibold", {
                        ...
                        "bg-red-100 text-red-800": row.getValue("deliveryStatus") === "PENDING",
    ...
    return (
        <div className="space-y-6">
            <Tabs value={activeTab} onValueChange={(value) => {
                setActive(value as "today" | "week" | "month")
            }}>
            ...
            <div className="flex items-center justify-end space-x-2 py-4">
                ...
                <Button variant="outline" size="sm" onClick={() => table.nextPage()} disabled={!table.getCanNextPage() || isFetching}>Next</Button>
            </div>
        </div>
    )
}